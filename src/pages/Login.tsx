    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-3 font-medium">{t('enterArena')}</p>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-gradient-card backdrop-blur-xl p-7 shadow-card neon-border">
          ...
          <p className="text-center text-xs text-muted-foreground mt-5">
            {t('newHere')} <a className="text-neon-cyan font-semibold hover:underline cursor-pointer">{t('createAccount')}</a>
          </p>
        </div>
