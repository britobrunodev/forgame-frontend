  ...
  return (
    <AuthShell mode="login" title={t('login')} subtitle={t('loginIntro')}>
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-secondary py-2.5 text-sm font-semibold transition-smooth hover:border-primary/40"
      >
