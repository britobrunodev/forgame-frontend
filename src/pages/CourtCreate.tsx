  ...
  return (
    <div className="mx-auto w-full max-w-[min(108rem,calc(100vw-2rem))] space-y-8 xl:max-w-[min(116rem,calc(100vw-3rem))]">
      <header className="flex items-center gap-4">
        ...
        <div>
          <p className="font-display text-sm font-bold uppercase tracking-[0.28em] text-neon-cyan">{t('addCourt')}</p>
          <p className="mt-0.5 text-xs text-muted-foreground">{t('createCourtIntro')}</p>
        </div>
      </header>
