...
export const MANAGED_PLAYERS: ManagedPlayer[] = [
  ...
  },
  {
    id: "pl2",
    name: "Sandrey Lima",
    email: "sandrey@jogajunto360.com",
    complexId: "p1",
    sports: ["footvolley"],
    level: "professional",
    score: 1860,
  ...
  },
  {
    id: "pl8",
    name: "Lucas Prado",
    email: "lucas@jogajunto360.com",
    complexId: "p3",
    sports: ["beach-soccer", "footvolley"],
    level: "advanced",
    score: 1360,
  },
  { id: "pl9",  name: "Fernanda Rocha",   email: "fernanda@jogajunto360.com",  complexId: "p2", sports: ["footvolley"],               level: "beginner",      score: 890  },
  { id: "pl10", name: "Thiago Cardoso",   email: "thiago@jogajunto360.com",    complexId: "p2", sports: ["volleyball", "footvolley"], level: "intermediate",  score: 1150 },
  { id: "pl11", name: "Isabela Matos",    email: "isa@jogajunto360.com",       complexId: "p3", sports: ["beach-soccer"],             level: "beginner",      score: 760  },
  { id: "pl12", name: "Rodrigo Ferreira", email: "rodrigo@jogajunto360.com",   complexId: "p3", sports: ["footvolley", "beach-soccer"], level: "gold",        score: 1720 },
  { id: "pl13", name: "Camila Duarte",    email: "camila@jogajunto360.com",    complexId: "p2", sports: ["footvolley"],               level: "silver",        score: 1530 },
  { id: "pl14", name: "André Fonseca",    email: "andre@jogajunto360.com",     complexId: "p3", sports: ["beach-soccer"],             level: "advanced",      score: 1420 },
  { id: "pl15", name: "Patrícia Mendes",  email: "patricia@jogajunto360.com",  complexId: "p2", sports: ["volleyball"],               level: "intermediate",  score: 1080 },
  { id: "pl16", name: "Felipe Azevedo",   email: "felipe@jogajunto360.com",    complexId: "p3", sports: ["footvolley", "beach-soccer"], level: "professional", score: 1930 },
  { id: "pl17", name: "Mariana Teixeira", email: "mariana@jogajunto360.com",   complexId: "p2", sports: ["footvolley"],               level: "beginner",      score: 840  },
  { id: "pl18", name: "Gustavo Lopes",    email: "gustavo@jogajunto360.com",   complexId: "p3", sports: ["beach-soccer"],             level: "intermediate",  score: 1270 },
  { id: "pl19", name: "Juliana Barros",   email: "juliana@jogajunto360.com",   complexId: "p2", sports: ["volleyball", "footvolley"], level: "advanced",      score: 1390 },
  { id: "pl20", name: "Eduardo Cunha",    email: "eduardo@jogajunto360.com",   complexId: "p3", sports: ["footvolley"],               level: "silver",        score: 1560 },
  { id: "pl21", name: "Larissa Vieira",   email: "larissa@jogajunto360.com",   complexId: "p1", sports: ["beach-tennis"],             level: "gold",          score: 1680 },
  { id: "pl22", name: "Bruno Monteiro",   email: "bmont@jogajunto360.com",     complexId: "p1", sports: ["footvolley"],               level: "intermediate",  score: 1200 },
  { id: "pl23", name: "Natália Campos",   email: "natalia@jogajunto360.com",   complexId: "p4", sports: ["beach-tennis"],             level: "silver",        score: 1510 },
  { id: "pl24", name: "Diego Santana",    email: "diego@jogajunto360.com",     complexId: "p4", sports: ["beach-tennis", "volleyball"], level: "advanced",    score: 1440 },
  { id: "pl25", name: "Aline Ribeiro",    email: "aline@jogajunto360.com",     complexId: "p2", sports: ["footvolley"],               level: "beginner",      score: 910  },
];
...
export const MANAGED_COURT_PAYMENTS: ManagedCourtPayment[] = [
  ...
  { id: "cp5",  complexId: "p2", courtId: "ct3", courtName: "Quadra Central", reservationDate: addDays(today, -1), timeSlot: "07:00 - 08:00", userId: "pl9",  userName: "Fernanda Rocha",   userEmail: "fernanda@jogajunto360.com", totalAmount: 140, paidAmount: 140, remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2010", reference: "PIX-10001", amount: 140, method: "pix",         paidAt: "2026-05-01 06:50", status: "paid"    }] },
  { id: "cp6",  complexId: "p2", courtId: "ct4", courtName: "Quadra 4",       reservationDate: addDays(today, -1), timeSlot: "10:00 - 11:00", userId: "pl10", userName: "Thiago Cardoso",   userEmail: "thiago@jogajunto360.com",  totalAmount: 110, paidAmount: 55,  remainingAmount: 55,  status: "pending", transactions: [{ id: "ctx-2011", reference: "CARD-10002", amount: 55,  method: "credit-card", paidAt: "2026-05-01 09:30", status: "paid"    }] },
  { id: "cp7",  complexId: "p3", courtId: "ct5", courtName: "Arena 1",        reservationDate: addDays(today, -2), timeSlot: "14:00 - 15:00", userId: "pl11", userName: "Isabela Matos",    userEmail: "isa@jogajunto360.com",     totalAmount: 95,  paidAmount: 0,   remainingAmount: 95,  status: "pending", transactions: [{ id: "ctx-2012", reference: "PIX-10003", amount: 95,  method: "pix",         paidAt: "2026-04-30 13:00", status: "failed"  }] },
  { id: "cp8",  complexId: "p3", courtId: "ct6", courtName: "Arena 2",        reservationDate: addDays(today, -2), timeSlot: "16:00 - 17:00", userId: "pl12", userName: "Rodrigo Ferreira", userEmail: "rodrigo@jogajunto360.com", totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2013", reference: "PIX-10004", amount: 95,  method: "pix",         paidAt: "2026-04-30 15:45", status: "paid"    }] },
  { id: "cp9",  complexId: "p2", courtId: "ct3", courtName: "Quadra Central", reservationDate: addDays(today, -3), timeSlot: "08:00 - 09:00", userId: "pl13", userName: "Camila Duarte",    userEmail: "camila@jogajunto360.com",  totalAmount: 140, paidAmount: 140, remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2014", reference: "DEBIT-10005", amount: 140, method: "debit-card", paidAt: "2026-04-29 07:55", status: "paid"    }] },
  { id: "cp10", complexId: "p2", courtId: "ct4", courtName: "Quadra 4",       reservationDate: addDays(today, -3), timeSlot: "19:00 - 20:00", userId: "pl15", userName: "Patrícia Mendes",  userEmail: "patricia@jogajunto360.com", totalAmount: 110, paidAmount: 110, remainingAmount: 0,  status: "paid",    transactions: [{ id: "ctx-2015", reference: "CARD-10006", amount: 110, method: "credit-card", paidAt: "2026-04-29 18:40", status: "paid"    }] },
  { id: "cp11", complexId: "p3", courtId: "ct5", courtName: "Arena 1",        reservationDate: addDays(today, -4), timeSlot: "09:00 - 10:00", userId: "pl14", userName: "André Fonseca",    userEmail: "andre@jogajunto360.com",   totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2016", reference: "PIX-10007", amount: 95,  method: "pix",         paidAt: "2026-04-28 08:50", status: "paid"    }] },
  { id: "cp12", complexId: "p2", courtId: "ct3", courtName: "Quadra Central", reservationDate: addDays(today, -4), timeSlot: "11:00 - 12:00", userId: "pl17", userName: "Mariana Teixeira", userEmail: "mariana@jogajunto360.com", totalAmount: 140, paidAmount: 0,   remainingAmount: 140, status: "pending", transactions: [{ id: "ctx-2017", reference: "PIX-10008", amount: 140, method: "pix",         paidAt: "2026-04-28 10:30", status: "failed"  }] },
  { id: "cp13", complexId: "p3", courtId: "ct6", courtName: "Arena 2",        reservationDate: addDays(today, -5), timeSlot: "17:00 - 18:00", userId: "pl16", userName: "Felipe Azevedo",   userEmail: "felipe@jogajunto360.com",  totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2018", reference: "PIX-10009", amount: 95,  method: "pix",         paidAt: "2026-04-27 16:55", status: "paid"    }] },
  { id: "cp14", complexId: "p2", courtId: "ct4", courtName: "Quadra 4",       reservationDate: addDays(today, -5), timeSlot: "13:00 - 14:00", userId: "pl19", userName: "Juliana Barros",   userEmail: "juliana@jogajunto360.com", totalAmount: 110, paidAmount: 110, remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2019", reference: "CARD-10010", amount: 110, method: "credit-card", paidAt: "2026-04-27 12:50", status: "paid"    }] },
  { id: "cp15", complexId: "p3", courtId: "ct5", courtName: "Arena 1",        reservationDate: addDays(today, -6), timeSlot: "10:00 - 11:00", userId: "pl18", userName: "Gustavo Lopes",    userEmail: "gustavo@jogajunto360.com", totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2020", reference: "PIX-10011", amount: 95,  method: "pix",         paidAt: "2026-04-26 09:45", status: "paid"    }] },
  { id: "cp16", complexId: "p2", courtId: "ct3", courtName: "Quadra Central", reservationDate: addDays(today, -6), timeSlot: "15:00 - 16:00", userId: "pl20", userName: "Eduardo Cunha",    userEmail: "eduardo@jogajunto360.com", totalAmount: 140, paidAmount: 140, remainingAmount: 0,   status: "paid",    transactions: [{ id: "ctx-2021", reference: "PIX-10012", amount: 140, method: "pix",         paidAt: "2026-04-26 14:55", status: "paid"    }] },
];
...
export const MANAGED_THIRD_PARTY_PAYMENTS: ManagedThirdPartyPayment[] = [
  ...
  { id: "wh3",  complexId: "p2", sourceType: "wellhub",    userName: "Fernanda Rocha",   userEmail: "fernanda@jogajunto360.com",  date: "2026-04-27", totalAmount: 85,  paidAmount: 85,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "wh-txn-3",   reference: "WELLHUB-00130",   amount: 85,  method: "pix",         paidAt: "2026-04-27 10:00", status: "paid"   }] },
  { id: "wh4",  complexId: "p2", sourceType: "wellhub",    userName: "Thiago Cardoso",   userEmail: "thiago@jogajunto360.com",   date: "2026-04-26", totalAmount: 85,  paidAmount: 85,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "wh-txn-4",   reference: "WELLHUB-00131",   amount: 85,  method: "pix",         paidAt: "2026-04-26 09:15", status: "paid"   }] },
  { id: "wh5",  complexId: "p3", sourceType: "wellhub",    userName: "André Fonseca",    userEmail: "andre@jogajunto360.com",    date: "2026-04-25", totalAmount: 85,  paidAmount: 0,   remainingAmount: 85, status: "pending", transactions: [{ id: "wh-txn-5",   reference: "WELLHUB-00132",   amount: 85,  method: "credit-card", paidAt: "2026-04-25 14:30", status: "failed" }] },
  { id: "wh6",  complexId: "p2", sourceType: "wellhub",    userName: "Patrícia Mendes",  userEmail: "patricia@jogajunto360.com", date: "2026-04-24", totalAmount: 85,  paidAmount: 85,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "wh-txn-6",   reference: "WELLHUB-00133",   amount: 85,  method: "pix",         paidAt: "2026-04-24 11:00", status: "paid"   }] },
  { id: "tp3",  complexId: "p3", sourceType: "totalpass",  userName: "Isabela Matos",    userEmail: "isa@jogajunto360.com",      date: "2026-04-29", totalAmount: 75,  paidAmount: 75,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "tp-txn-3",   reference: "TOTALPASS-55003", amount: 75,  method: "pix",         paidAt: "2026-04-29 09:00", status: "paid"   }] },
  { id: "tp4",  complexId: "p2", sourceType: "totalpass",  userName: "Camila Duarte",    userEmail: "camila@jogajunto360.com",   date: "2026-04-28", totalAmount: 75,  paidAmount: 75,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "tp-txn-4",   reference: "TOTALPASS-55004", amount: 75,  method: "debit-card",  paidAt: "2026-04-28 08:40", status: "paid"   }] },
  { id: "tp5",  complexId: "p3", sourceType: "totalpass",  userName: "Gustavo Lopes",    userEmail: "gustavo@jogajunto360.com",  date: "2026-04-27", totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "tp-txn-5",   reference: "TOTALPASS-55005", amount: 95,  method: "pix",         paidAt: "2026-04-27 16:00", status: "paid"   }] },
  { id: "tp6",  complexId: "p2", sourceType: "totalpass",  userName: "Mariana Teixeira", userEmail: "mariana@jogajunto360.com",  date: "2026-04-26", totalAmount: 75,  paidAmount: 0,   remainingAmount: 75, status: "pending", transactions: [{ id: "tp-txn-6",   reference: "TOTALPASS-55006", amount: 75,  method: "pix",         paidAt: "2026-04-26 15:10", status: "failed" }] },
  { id: "wh7",  complexId: "p3", sourceType: "wellhub",    userName: "Rodrigo Ferreira", userEmail: "rodrigo@jogajunto360.com",  date: "2026-04-23", totalAmount: 85,  paidAmount: 85,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "wh-txn-7",   reference: "WELLHUB-00140",   amount: 85,  method: "pix",         paidAt: "2026-04-23 10:30", status: "paid"   }] },
  { id: "wh8",  complexId: "p2", sourceType: "wellhub",    userName: "Felipe Azevedo",   userEmail: "felipe@jogajunto360.com",   date: "2026-04-22", totalAmount: 85,  paidAmount: 85,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "wh-txn-8",   reference: "WELLHUB-00141",   amount: 85,  method: "credit-card", paidAt: "2026-04-22 09:00", status: "paid"   }] },
  { id: "tp7",  complexId: "p3", sourceType: "totalpass",  userName: "Juliana Barros",   userEmail: "juliana@jogajunto360.com",  date: "2026-04-21", totalAmount: 95,  paidAmount: 95,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "tp-txn-7",   reference: "TOTALPASS-55010", amount: 95,  method: "pix",         paidAt: "2026-04-21 14:45", status: "paid"   }] },
  { id: "tp8",  complexId: "p2", sourceType: "totalpass",  userName: "Eduardo Cunha",    userEmail: "eduardo@jogajunto360.com",  date: "2026-04-20", totalAmount: 75,  paidAmount: 75,  remainingAmount: 0,  status: "paid",    transactions: [{ id: "tp-txn-8",   reference: "TOTALPASS-55011", amount: 75,  method: "debit-card",  paidAt: "2026-04-20 11:20", status: "paid"   }] },
];
...
export const CLASS_SCHEDULE: ClassSlot[] = [
  ...
  { id: 'cls-06', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Carol Tavares', date: d0, startTime: '08:00', endTime: '09:00', maxSpots: 6, bookedSpots: 4, level: 'silver' },
  { id: 'cls-07', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Marina Costa', date: d0, startTime: '10:00', endTime: '11:00', maxSpots: 6, bookedSpots: 6, level: 'gold' },
  ...
  { id: 'cls-12', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Carol Tavares', date: d1, startTime: '09:00', endTime: '10:00', maxSpots: 6, bookedSpots: 2, level: 'silver' },
  ...
  { id: 'cls-17', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Marina Costa', date: d2, startTime: '09:00', endTime: '10:00', maxSpots: 6, bookedSpots: 3, level: 'gold' },
  ...
  { id: 'cls-22', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Carol Tavares', date: d3, startTime: '09:00', endTime: '10:00', maxSpots: 6, bookedSpots: 5, level: 'silver' },
  ...
  { id: 'cls-26', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Marina Costa', date: d4, startTime: '10:00', endTime: '11:00', maxSpots: 6, bookedSpots: 1, level: 'gold' },
  ...
  { id: 'cls-30', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Carol Tavares', date: d5, startTime: '08:00', endTime: '09:00', maxSpots: 6, bookedSpots: 3, level: 'silver' },
  ...
  { id: 'cls-34', complexId: 'p4', complexName: 'Jurerê Beach Club', sport: 'beach-tennis', professorName: 'Marina Costa', date: d6, startTime: '10:00', endTime: '11:00', maxSpots: 6, bookedSpots: 4, level: 'gold' },
